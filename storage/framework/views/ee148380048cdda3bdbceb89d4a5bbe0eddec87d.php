                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                        ...
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            ...
                            <h6 class="fw-bold mt-3 mb-0">Siswa Lulus</h6>
                        </div>
                        <div class="px-2 pb-2 pb-md-0 text-center">
                            <div id="circles-3"></div>
                            <h6 class="fw-bold mt-3 mb-0">Penentuan Kelas</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-info card-annoucement card-round">
                <div class="card-body text-center">
                    ...
                    <div class="card-detail">
                        <a href="<?php echo e(url('activity')); ?>" class="btn btn-light btn-rounded">View Profile</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('template.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pribadi_plen\sisfo_me\resources\views/template/default.blade.php ENDPATH**/ ?>