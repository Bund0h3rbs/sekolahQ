...
<div class="modal-header pb-2">
  ...
  <div class="modal-body">
    <div class="text-center">
        <dt class="text-12">Form Mata Pelajaran</dt>
...
$('.select2').select2({
    ...
    function saveform()
    {
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('mapel.store')); ?>",
...
<?php /**PATH D:\xampp\htdocs\new_project\sisfo_me\resources\views/management/matapel/formcreate.blade.php ENDPATH**/ ?>