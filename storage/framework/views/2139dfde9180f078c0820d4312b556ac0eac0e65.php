  ...
  <div class="modal-body">
    ...
    <div class="col-md-12 mt-2">
        <div class="form-group">
            ...
            <?php echo e(Form::text('name',$data->users->name ?? null, array('class'=>'form-control border-br10', 'required','id'=>'Amin','placeholder'=>'Ex: Admin'))); ?>
        ...
        <div class="form-group">
            <label>Email</label>
            <div class="input-group">
            <?php echo e(Form::email('email',$data->users->email ?? null, array('class'=>'form-control border-br10', 'required','id'=>'name','placeholder'=>'Kelas 1'))); ?>

            </div>
        </div>
        <div class="form-group">
            <label>Akses Login </label>
            <?php echo e(Form::select('akses_id',[''=>'-- Pilih --']+$aksesRole, $data->akses_id ?? null,array('class'=>'form-control select2 border-br-10','required'))); ?>
...
$('.select2').select2({
    ...
    function saveform()
    {
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('aksesuser.store')); ?>",
...
<?php /**PATH D:\xampp\htdocs\new_project\sisfo_me\resources\views/management/aksesuser/formcreate.blade.php ENDPATH**/ ?>