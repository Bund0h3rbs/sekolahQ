                ...
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">
                            <dt>Daftar List</dt>
                            <div class="text-muted mt-0" style="font-size:0.9rem">Daftar Tahun Ajaran</div>
                        </div>
...
<?php
    $recordsUrl = route('akayear.getlist');
...
<script>
    ...
    $('#add_data').click(function(){
        $.ajax({
            type:"POST",
            url: "<?php echo e(route('akayear.create')); ?>",
            data: {
    ...
    function deletemenu(id)
    {
        swal({
            ...
            if (Delete) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('akayear.delete')); ?>",
                    data:{"id":id},
                    headers: {
