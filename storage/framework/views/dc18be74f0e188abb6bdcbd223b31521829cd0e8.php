...
<script>
    ...
    $('#add_data').click(function(){
        $.ajax({
            type:"POST",
            url: "<?php echo e(route('aksesuser.create')); ?>",
            data: {
    ...
    function deletemenu(id)
    {
        swal({
            ...
            if (Delete) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('aksesuser.delete')); ?>",
                    data:{"id":id},
                    headers: {
    ...
    function resetPassword(id){
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('aksesuser.resetpassword')); ?>",
                    data:{"id":id},
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
