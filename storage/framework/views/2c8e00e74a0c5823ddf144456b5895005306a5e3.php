  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary ">
        ...
        <?php echo \App\Librari\Menusakses::instance()->getMenus(); ?>


        <li class="nav-section b-0">
            <h4 class="text-section ">@copy  -Sekolah <?php echo e(date('Y')); ?></h4>
          </li>
      </ul>
    </div>
  </div>
</div>
<?php /**PATH D:\xampp\htdocs\pribadi_plen\sisfo_me\resources\views/template/menus.blade.php ENDPATH**/ ?>