  ...
  <div class="modal-body">
    ...
    <div class="col-md-12 mt-2">
        <div class="form-group">
            ...
            <?php echo e(Form::text('code',$data->code ?? null, array('class'=>'form-control border-br10', 'required','id'=>'code','placeholder'=>'22/23'))); ?>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
            <?php echo e(Form::text('name',$data->name ?? null, array('class'=>'form-control border-br10', 'required','id'=>'name','placeholder'=>'TA. 2022/2023'))); ?>
...
$('.select2').select2({
    ...
    function saveform()
    {
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('akayear.store')); ?>",
...
<?php /**PATH D:\xampp\htdocs\new_project\sisfo_me\resources\views/management/tahun_akademik/formcreate.blade.php ENDPATH**/ ?>