    ...
    <div class="container" >
      <div class="row">
        <div class="col-md-6 order-md-2" style="margin-top:-5rem;">
          <img src="<?php echo e(asset('assets/img/login.png')); ?>" alt="Image" class="img-fluid">
        </div>
...
<?php /**PATH D:\xampp\htdocs\pribadi_plen\sisfo_me\resources\views/auth/login-sisfo.blade.php ENDPATH**/ ?>