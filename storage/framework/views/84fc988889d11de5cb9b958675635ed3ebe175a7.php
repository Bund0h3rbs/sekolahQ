  ...
  <div class="modal-body">
    ...
    <div class="col-md-12 mt-2">
        <div class="form-group">
            ...
            <?php echo e(Form::text('name',$data->name ?? null, array('class'=>'form-control border-br10', 'required','id'=>'name','placeholder'=>'Pengaturan'))); ?>
        ...
        <div class="form-group row">
            <div class="col-md-8">
                <label>Parent</label>
                <?php echo e(Form::select('parent',[''=>'-- Pilih --']+$parent, $data->parent ?? null,array('class'=>'form-control select2 border-br-10'))); ?>
            ...
            <div class="col-md-4">
                <label>Urutan</label>
                <div class="input-group">
                <?php echo e(Form::number('no_urut',$data->no_urut ?? null, array('class'=>'form-control border-br10','id'=>'no_urut','placeholder'=>'1','required'))); ?>
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::text('link',$data->link ?? null, array('class'=>'form-control border-br10','id'=>'link','placeholder'=>'Pengaturan'))); ?>

            <span class="text-muted text-8">referensi akses route menu</span>
        </div>
        <div class="form-group">
            <label>Icon </label>
            <?php echo e(Form::text('icon',$data->icon ?? null, array('class'=>'form-control border-br10','id'=>'icon','placeholder'=>'Pengaturan'))); ?>
...
<?php /**PATH D:\xampp\htdocs\new_project\sisfo_me\resources\views/management/menus/formcreate.blade.php ENDPATH**/ ?>